...
<title>2013 Honda Grand Prix of St Petersburg  --- Test CountDownTo</title>
...
function Countdown() {
	...
	this.regional[''] = { // Default regional settings
		...
		labels: ['Years', 'Months', 'Wks', 'Days', 'Hrs', 'Mins', 'Secs'],
		// The display texts for the counters if only one
		labels1: ['Year', 'Month', 'Wk', 'Day', 'Hr', 'Min', 'Sec'],
...
<script type="text/javascript">
  ...
  $('.CountDownTo').html(function() {
					// Grab classes and store in an array
					var classStr = $(this).attr('class').split(' ');
					// Grab second class and store as variable
					var unix_date = classStr[1];
					// Convert Unix date (seconds) to milliseconds for Javascript
					var javaDate = new Date(unix_date * 1000);				
					// Activate countdown timer on the DOM object
					$(this).countdown({until: javaDate, format: 'dHMS', alwaysExpire:true, onExpiry:hide});
					});
	function hide(){
	$(this).hide();
};
...
<p><STRONG>Saturday, March   24</STRONG>
<img src="News_icon.png" alt="newspaper">
</p>
<table width="100%" border="0" cellspacing="8">
  <tr>
    ...
    <tr>
    <td width="25%"><div class="CountDownTo <?php echo time()+20; ?>"></div></td>
    <td width="34%"><div align="center">start at 20 seconds (php)</div></td>
    <td width="41%"><strong>Race 1</strong></td>
  </tr>
    <tr>
    <td width="25%"><div class="CountDownTo 1357236732"></div></td>
    <td width="34%"><div align="center">1 / 3 / 2013 @ 12:12 EST</div></td>
    <td width="41%"><strong>Race 2</strong></td>
  </tr>
    <tr>
    <td width="25%"><div class="CountDownTo 1364317920"></div></td>
    <td width="34%"><div align="center">3 / 26 / 2013 @ 12:12 EST</div></td>
    <td width="41%"><strong>Race 3</strong></td>
  </tr>
  <tr>
    <td width="25%"><div class="CountDownTo 1390248000"></div></td>
    <td width="34%"><div align="center">1 / 20 / 2014 @ 14:00 EST</div></td>
    <td width="41%"><strong>PWC Qualifying</strong></td>
  </tr>
    <tr>
    <td><div class="CountDownTo 1357495920"></div></td>
    <td><div align="center">1 / 6 / 2013 @ 12:12:00 EST</div></td>
...
<span style="font-size:.8em;">Rahal, Kimball, Wilson, Jakes, Andretti, Hunter-Reay, Hinchcliﬀe, 
...
<!-- BEGIN Anonymous Visitor Tracking for City Website Statistics and Usability Reports -->
